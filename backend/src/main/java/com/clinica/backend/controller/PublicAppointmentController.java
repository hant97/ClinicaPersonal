...
public class PublicAppointmentController {
    ...
    public ResponseEntity<PublicAppointmentConfirmationDto> getConfirmation(@PathVariable String token) {
        return ResponseEntity.ok(confirmationService.getConfirmationByToken(token));
    }
